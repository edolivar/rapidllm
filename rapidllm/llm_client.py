...
class RapidClientSettings(BaseModel):
    ...
    api_key: str = Field(default="anything", description="API key for the LLM service.")
...
class RapidClient:
    ...
    def transcribe_audio(self, audio_path: str) -> Optional[str]:
        ...
        full_audio_path = os.path.join(
            "audio", audio_path
        )  # Assuming 'audio' folder convention
    ...
    def generate_chat_response(
        ...
        if audio_path:
            ...
            if transcribed_text:
                ...
                app_logger.warning(
                    "Could not transcribe audio. Proceeding with text message only."
                )
